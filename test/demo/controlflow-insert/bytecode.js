...
module.exports = {
  ...
  timelines: {
    Default: {
      ...
      '#box1': {'translation.x':{0:{value:0,curve:'linear'},1000:{value:150}},'sizeProportional.y':{0:{value: 0.1}},'controlFlow.insert':{0:{value:2}}},
      '#box2': {'translation.x':{0:{value:0,curve:'linear'},1000:{value: 60}},'sizeProportional.y':{0:{value: 0.1}},'controlFlow.insert':{0:{value:1}}},
      '#box3': {'translation.x':{0:{value:0,curve:'linear'},1000:{value:200}},'sizeProportional.y':{0:{value: 0.1}},'controlFlow.insert':{0:{value:N}}},
      '#box4': {'translation.x':{0:{value:0,curve:'linear'},1000:{value:103}},'sizeProportional.y':{0:{value: 0.1}},'controlFlow.insert':{0:{value:0}}}
    }
  },
  template: `
    <div>
