    ...
    Default: {
      ...
      'haiku:89693021ef05': {
        d: {
          '0': {
            value:
              'M19.6286214,36.3727324 L3.41352075,36.5014089 C3.41352075,36.5014089 3.061071,27.8457241 7.63362116,27.8457241 C12.2061713,27.8457241 16.0189249,27.9641048 16.0189249,27.9641048 L24.850433,48.4675004 L35.9602073,48.4675004 L54.8806322,35.5570706 L51.8689241,22.6396002 L58.5601129,50.7933788'
          }
        },
        stroke: { '0': { value: '#59429B' } },
      ...
      'haiku:dc1ddefa5f17': {
        d: {
          '0': {
            value:
              'M60.7349356,36.3758027 C60.7349356,36.3758027 64.3082232,31.0366595 59.6103627,26.4500314 C56.4387969,24.5015553 56.556144,36.3758027 56.556144,36.3758027 L60.7349356,36.3758027 Z'
          }
        },
        stroke: { '0': { value: '#59429B' } },
        'stroke-width': { '0': { value: '3' } },
      ...
      'haiku:30c414713ccc': {
        d: {
          '0': {
            value:
              'M34.9332199,35.965405 C34.9332199,35.965405 33.0627641,28.4067059 42.143556,28.2319356 C51.2243479,28.0571653 52.8679394,28.2319356 52.8679394,28.2319356'
          }
        },
        stroke: { '0': { value: '#59429B' } },
        'stroke-width': { '0': { value: '3' } },
      ...
      'haiku:356cbc45061b': {
        d: {
          '0': {
            value:
              'M26.1267,14.5377037 C20.7970325,28.0774853 19.7547581,27.6047024 20.2890058,31.9585167 C20.8232535,36.312331 27.8520112,33.7894637 32.4465542,38.1084244 C37.0410971,42.4273852 43.1837858,46.4358362 43.1837858,46.4358362 L48.4273776,41.8578583 C48.4273776,41.8578583 47.3066362,38.4013516 45.245211,40.129605 C43.1837858,41.8578583 34.4204257,29.8768611 32.8703608,29.3655859 C31.320296,28.8543107 34.4361399,20.4712709 34.4361399,18.8640727 C34.4361399,17.2568744 41.8502586,23.1151984 46.8529435,24.0822022 C51.8556285,25.049206 53.5814747,23.5915694 53.5814747,23.5915694 C53.5814747,23.5915694 54.8440014,21.4445314 52.3511072,21.1975815 C49.858213,20.9506316 48.3163343,23.9547426 37.4987511,15.2373261 C35.1749975,12.7463732 36.2759295,10.035068 36.2759295,10.035068 C36.2759295,10.035068 37.372242,7.37134488 37.6232428,6.7550374 C37.8742436,6.13872992 29.7409761,7.00437862 29.7409761,7.00437862 C29.7409761,7.00437862 27.6240501,10.2683232 26.1267,14.5377037 Z'
          }
        },
        fill: { '0': { value: '#BA8EEF' } }
      },
      'haiku:0dd1373d913a': {
        d: {
          '0': {
            value:
              'M39,5.5 C39,2.46243388 36.5375661,0 33.5,0 C30.4624339,0 28,2.46243388 28,5.5 C28,5.83897896 26.8049302,5.85281632 24.4877236,6.83997698 C22.5745494,7.65501447 20.9814487,8.9810681 25.1754107,8.27147963 C26.3937487,8.06534553 27.3916154,7.82311623 29.445493,7.42540577 C32.8112146,6.77367139 39,7.83741036 39,5.5 Z'
          }
        },
        fill: { '0': { value: '#E97897' } }
      },
      ...
      'haiku:e33a15bfe59f': {
        ...
        'translation.x': {
          ...
          '1750': { value: 80, edited: true },
          '2867': { value: 290, edited: true, curve: 'easeInOutCubic' },
          '3367': { value: 221, edited: true }
        },
        'translation.y': {
          '0': { value: 344, edited: true },
          '1300': { value: 344, edited: true, curve: 'easeOutCirc' },
          '1750': { value: 320, edited: true },
          '2867': { value: 333, edited: true, curve: 'easeInOutCubic' },
          '3367': { value: 319, edited: true }
        },
        'style.zIndex': { '0': { value: 8 } },
        opacity: {
          '0': { value: 0, edited: true },
          '1300': { value: 1, edited: true },
          '1500': { value: 1, edited: true, curve: 'linear' },
          '1750': { value: 0, edited: true },
          '2867': { value: 1, edited: true },
          '3133': { value: 1, edited: true, curve: 'linear' },
          '3367': { value: 0, edited: true }
        },
        'scale.x': {
          '0': { value: 1 },
          '1300': { value: 0.1, edited: true, curve: 'linear' },
          '1750': { value: 1.7, edited: true },
          '2867': { value: 0.1, edited: true, curve: 'easeOutCirc' },
          '3367': { value: 1.7, edited: true }
        },
        'scale.y': {
          '0': { value: 1 },
          '1300': { value: 0.1, edited: true, curve: 'linear' },
      ...
      'haiku:f0cbd1e72e50': {
        ...
        'translation.x': {
          ...
          '1750': { value: 110, edited: true },
          '2967': { value: 280, edited: true, curve: 'easeInOutCubic' },
          '3367': { value: 242.5, edited: true }
        },
        'translation.y': {
          '0': { value: 310, edited: true },
          '1383': { value: 340, edited: true, curve: 'easeInOutCubic' },
          '1750': { value: 323, edited: true },
          '2967': { value: 333, edited: true, curve: 'easeInOutCubic' },
          '3367': { value: 316, edited: true }
        },
        'style.zIndex': { '0': { value: 10 } },
        opacity: {
          '0': { value: 0, edited: true },
          '1383': { value: 1, edited: true },
          '1533': { value: 1, edited: true, curve: 'linear' },
          '1750': { value: 0, edited: true },
          '2967': { value: 1, edited: true },
          '3217': { value: 1, edited: true, curve: 'linear' },
          '3367': { value: 0, edited: true }
        },
        'scale.x': {
          '0': { value: 1 },
          '1383': { value: 0.1, edited: true, curve: 'linear' },
          '1750': { value: 2.7, edited: true },
          '2967': { value: 0.1, edited: true, curve: 'easeOutCubic' },
          '3367': { value: 2.7, edited: true }
        },
        'scale.y': {
          '0': { value: 1 },
          '1383': { value: 0.1, edited: true, curve: 'linear' },
      ...
      'haiku:31cc24a778e8': {
        ...
        'style.border': { '0': { value: '0' } },
        'translation.x': {
          '0': { value: 146.5, edited: true },
          '1233': { value: 146.5, edited: true, curve: 'easeInOutCubic' },
          '1750': { value: 94, edited: true },
          '2733': { value: 280, edited: true, curve: 'easeInOutCirc' },
          '3367': { value: 228, edited: true }
        },
        'translation.y': {
          '0': { value: 343, edited: true },
          '1217': { value: 343, edited: true, curve: 'easeInOutCubic' },
          '1750': { value: 310, edited: true },
          '2733': { value: 333, edited: true, curve: 'easeInOutExpo' },
          '3367': { value: 330, edited: true }
        },
        'style.zIndex': { '0': { value: 11 } },
        opacity: {
          '0': { value: 0, edited: true },
          '1217': { value: 1, edited: true },
          '1550': { value: 1, edited: true, curve: 'linear' },
          '1750': { value: 0, edited: true },
          '2733': { value: 1, edited: true },
          '3033': { value: 1, edited: true, curve: 'linear' },
          '3367': { value: 0, edited: true }
        },
        'scale.x': {
          '0': { value: 1 },
          '1217': { value: 0.1, edited: true, curve: 'linear' },
          '1750': { value: 1, edited: true },
          '2733': { value: 0.1, edited: true, curve: 'easeOutExpo' },
    ...
    children: [
      ...
      },
      {
        ...
        attributes: {
          ...
          'xmlns:xlink': 'http://www.w3.org/1999/xlink',
          source:
            'designs/moto-mountains.sketch.contents/slices/mountain-range.svg',
      ...
      },
      {
        ...
        attributes: {
          ...
          'xmlns:xlink': 'http://www.w3.org/1999/xlink',
          source:
            'designs/moto-mountains.sketch.contents/slices/tree-range.svg',
      ...
      },
      {
        ...
        attributes: {
          ...
          source: 'designs/moto-mountains.sketch.contents/slices/smoke.svg',
          'haiku-title': 'smoke',
          'haiku-id': '31cc24a778e8'
        },
        children: [
          {
            elementName: 'title',
            attributes: { 'haiku-id': 'a498228df1aa' },
            children: ['smoke']
          },
          {
            elementName: 'desc',
            attributes: { 'haiku-id': 'a5b278fa4cb2' },
            children: ['Created with sketchtool.']
          },
          {
            elementName: 'defs',
            attributes: { 'haiku-id': 'a3cacd136adf' },
            children: []
          },
          {
            elementName: 'g',
            attributes: { id: 'Page-1', 'haiku-id': '3f37eccb8612' },
            children: [
              {
                elementName: 'circle',
                attributes: { id: 'smoke', 'haiku-id': '43235fef72ed' },
                children: []
              }
            ]
          }
