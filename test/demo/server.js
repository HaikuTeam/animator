...
var swapPlayerRequirePath = tools.makeStringTransform('swapPlayerRequirePath', {}, function (content, options, done) {
  ...
  content = content.split(`'@haiku/player/dom/react'`).join(`'./../../../dom/react'`)
