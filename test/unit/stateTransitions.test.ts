  ...
  (t) => {
    ...
    TestHelpers.createComponent(
      ...
      (component, teardown, mount) => {
        ...
        t.deepEqual(
      [component.state.var1, component.state.var2],
      [0, 5],
