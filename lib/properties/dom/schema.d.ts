declare let has: any;
declare let TEXT_CONTENT_SCHEMA: {
    content: string;
};
declare let LAYOUT_3D_SCHEMA: {
    "shown": string;
    "opacity": string;
    "mount.x": string;
    "mount.y": string;
...
declare let PRESENTATION_SCHEMA: {
...
declare let HTML_STYLE_SHORTHAND_SCHEMA: {
    backgroundColor: string;
};
declare let CONTROL_FLOW_SCHEMA: {
    "controlFlow.repeat": string;
    "controlFlow.placeholder": string;
};
