...
function replaceElement(domElement, virtualElement, parentDomNode, parentVirtualElement, component) {
    ...
    if (isTextNode(virtualElement)) {
        ...
        newElement = createTagNode(domElement, virtualElement, parentVirtualElement, component);
    }
    applyLayout(newElement, virtualElement, parentDomNode, parentVirtualElement, component);
