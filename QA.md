...
- [ ] Install and embed the component in a React app
- [ ] Log in/log out using the CLI
...
- [ ] I can launch Haiku.app without seeing a crash/error
...
- [ ] Opening an old legacy with backgroundColor shows that as a timeline row
...
- [ ] I can nav back to the dashboard before the Glass/Timeline webviews have loaded w/o crashing
...
- [ ] Mixpanel transmits events for app launch, project launch, etc
...
- [ ] The lottie.json file works in editor.lottiefiles.com (http://editor.lottiefiles.com/)
...
- [ ] The Haiku CLI invalidates bad logins
...
- [ ] Player CDN links work (http://code.haiku.ai/scripts/player/HaikuPlayer.<{version}|latest>[.min].js (http://code.haiku.ai/scripts/player/HaikuPlayer.{version}.js))
- [ ] Player standalone repo has latest (https://github.com/HaikuTeam/player)
- [ ] Player npm package is up to date (https://www.npmjs.com/package/@haiku/player)
