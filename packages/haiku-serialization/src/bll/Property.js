...
Property.DISPLAY_RULES = {
  ...
  'haiku-id': {jit: [NEVER], add: [NEVER], keyframe: [NEVER]},
  'haiku-source': {jit: [NEVER], add: [NEVER], keyframe: [NEVER]},
  'haiku-title': {jit: [NEVER], add: [NEVER], keyframe: [NEVER]},
  'haiku-var': {jit: [NEVER], add: [NEVER], keyframe: [NEVER]},
  'height': {jit: [NEVER], add: [IF_DEFINED, IF_IN_SCHEMA], keyframe: [ALWAYS]},
  'offset.x': {jit: [NEVER], add: [NEVER], keyframe: [ALWAYS]},
  'offset.y': {jit: [NEVER], add: [NEVER], keyframe: [ALWAYS]},
  'offset.z': {jit: [NEVER], add: [NEVER], keyframe: [ALWAYS]},
  ...
  'origin.z': {jit: [NEVER], add: [NEVER], keyframe: [ALWAYS]},
  ...
  'shown': {jit: [NEVER], add: [NEVER], keyframe: [ALWAYS]},
  ...
  'sizeDifferential.x': {jit: [NEVER], add: [NEVER], keyframe: [ALWAYS]},
  'sizeDifferential.y': {jit: [NEVER], add: [NEVER], keyframe: [ALWAYS]},
  'sizeDifferential.z': {jit: [NEVER], add: [NEVER], keyframe: [ALWAYS]},
  'sizeMode.x': {jit: [NEVER], add: [NEVER], keyframe: [ALWAYS]},
  'sizeMode.y': {jit: [NEVER], add: [NEVER], keyframe: [ALWAYS]},
  'sizeMode.z': {jit: [NEVER], add: [NEVER], keyframe: [ALWAYS]},
  'sizeProportional.x': {jit: [NEVER], add: [NEVER], keyframe: [ALWAYS]},
  'sizeProportional.y': {jit: [NEVER], add: [NEVER], keyframe: [ALWAYS]},
  'sizeProportional.z': {jit: [NEVER], add: [NEVER], keyframe: [ALWAYS]},
  ...
  'style.borderBottom': {jit: [NEVER], add: [NEVER], keyframe: [ALWAYS]},
  'style.borderLeft': {jit: [NEVER], add: [NEVER], keyframe: [ALWAYS]},
  'style.borderRight': {jit: [NEVER], add: [NEVER], keyframe: [ALWAYS]},
  'style.borderTop': {jit: [NEVER], add: [NEVER], keyframe: [ALWAYS]},
  'style.color': {jit: [NEVER], add: [NEVER], keyframe: [ALWAYS]},
  ...
  'style.display': {jit: [NEVER], add: [NEVER], keyframe: [ALWAYS]},
  'style.height': {jit: [NEVER], add: [NEVER], keyframe: [ALWAYS]},
  ...
  'style.position': {jit: [NEVER], add: [NEVER], keyframe: [ALWAYS]},
  'style.textTransform': {jit: [ALWAYS], add: [NEVER], keyframe: [ALWAYS]},
  'style.transform': {jit: [NEVER], add: [NEVER], keyframe: [ALWAYS]},
  'style.transformOrigin': {jit: [NEVER], add: [NEVER], keyframe: [ALWAYS]},
  ...
  'style.width': {jit: [NEVER], add: [NEVER], keyframe: [ALWAYS]},
  'style.verticalAlign': {jit: [ALWAYS], add: [NEVER], keyframe: [ALWAYS]},
  'style.zIndex': {jit: [NON_ROOT_ONLY], add: [NON_ROOT_ONLY], keyframe: [ALWAYS]},
  'transform': {jit: [NEVER], add: [NEVER], keyframe: [ALWAYS]},
  'transformOrigin': {jit: [NEVER], add: [NEVER], keyframe: [ALWAYS]},
