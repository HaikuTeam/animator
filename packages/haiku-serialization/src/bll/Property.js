...
Property.DISPLAY_RULES = {
  ...
  'style.border': {jit: [NEVER], add: [IF_CHANGED_FROM_PREPOPULATED_VALUE]},
  'style.borderBottom': {jit: [NEVER], add: [NEVER]},
  'style.borderLeft': {jit: [NEVER], add: [NEVER]},
  'style.borderRight': {jit: [NEVER], add: [NEVER]},
  'style.borderTop': {jit: [NEVER], add: [NEVER]},
  'style.color': {jit: [NEVER], add: [NEVER]},
  ...
  'style.WebkitTapHighlightColor': {jit: [NEVER], add: [IF_CHANGED_FROM_PREPOPULATED_VALUE]},
