...
tape('ActiveComponent', (t) => {
  ...
  ac.on('component:mounted', () => {
    ...
    t.equal(out, 'element-heading.0|0.0.0 {e}\n    property.1|0.0.1.backgroundColor {s} {f} {e}\n    property.2|0.0.2.opacity\n    cluster-heading.3|0.0.3.sizeAbsolute[]\n        property.4|0.0.4.sizeAbsolute[].sizeAbsolute.x\n        property.5|0.0.5.sizeAbsolute[].sizeAbsolute.y\n    element-heading.6|1.0.0\n        property.7|1.0.1.opacity\n        cluster-heading.8|1.0.2.translation[]\n            property.9|1.0.3.translation[].translation.x\n            property.10|1.0.4.translation[].translation.y\n        cluster-heading.11|1.0.5.rotation[]\n            property.12|1.0.6.rotation[].rotation.x\n            property.13|1.0.7.rotation[].rotation.y\n            property.14|1.0.8.rotation[].rotation.z\n        cluster-heading.15|1.0.9.scale[]\n            property.16|1.0.10.scale[].scale.x\n            property.17|1.0.11.scale[].scale.y\n    element-heading.18|1.1.0\n        property.19|1.1.1.opacity\n        cluster-heading.20|1.1.2.translation[]\n            property.21|1.1.3.translation[].translation.x\n            property.22|1.1.4.translation[].translation.y\n        cluster-heading.23|1.1.5.rotation[]\n            property.24|1.1.6.rotation[].rotation.x\n            property.25|1.1.7.rotation[].rotation.y\n            property.26|1.1.8.rotation[].rotation.z\n        cluster-heading.27|1.1.9.scale[]\n            property.28|1.1.10.scale[].scale.x\n            property.29|1.1.11.scale[].scale.y\n        element-heading.30|2.0.0\n    element-heading.31|1.2.0\n        property.32|1.2.1.opacity\n        cluster-heading.33|1.2.2.translation[]\n            property.34|1.2.3.translation[].translation.x\n            property.35|1.2.4.translation[].translation.y\n        cluster-heading.36|1.2.5.rotation[]\n            property.37|1.2.6.rotation[].rotation.x\n            property.38|1.2.7.rotation[].rotation.y\n            property.39|1.2.8.rotation[].rotation.z\n        cluster-heading.40|1.2.9.scale[]\n            property.41|1.2.10.scale[].scale.x\n            property.42|1.2.11.scale[].scale.y', 'tree string out is ok')
