...
var pdum3 = [0, 0, 0];
exports.round = function (value) { return Number(value.toFixed(3)); };
function roundVector(vector) {
    return vector.map(function (value) { return exports.round(value); });
}
...
function decomposeMat4(matrix) {
    ...
    var translation = roundVector([tmp[12], tmp[13], tmp[14]]);
    ...
    return {
        ...
        rotation: roundVector(rotation),
        scale: roundVector(scale),
        shear: roundVector(shear),
    };
}
