...
export default function ({ styles, next }) {
  return (
    <Dialog>
      <h2>Summonables</h2>
      <div style={[styles.text, {width: 300}]}>
        <p>
          ...
          of the built-in summonables, visit our <a href='https://docs.haiku.ai/using-haiku/summonables.html' style={[styles.link, {display: 'inline'}]}>docs.</a>
        </p>
      </div>
