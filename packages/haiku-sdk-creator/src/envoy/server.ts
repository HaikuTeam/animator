...
export default class EnvoyServer {
    ...
    ready(): Promise<void> {
          return new Promise(function executor(resolve) {
                if (this.server && this.isServerReady) resolve(this)
     ...
     * @param handlerInstance optional - if not provided, bindHandler will instantiate an instance of handlerClass automatically with empty params.
     * @example
     ...
     * @param data the datagram object (request or response JSON blob)
     */
