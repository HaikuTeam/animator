...
ValueBuilder.prototype.getParser = function getParser(outputName, virtualElement) {
    ...
    if (!foundParser)
        foundParser = DOMValueParsers[virtualElement.elementName] && DOMValueParsers[virtualElement.elementName][outputName];
...
ValueBuilder.prototype.getGenerator = function getGenerator(outputName, virtualElement) {
    ...
    if (!foundGenerator)
        foundGenerator = DOMValueParsers[virtualElement.elementName] && DOMValueParsers[virtualElement.elementName][outputName];
    ...
    for (var propertyName in propertiesGroup) {
        ...
        if (!isPatchOperation ||
            ...
            if (out[propertyName] === undefined) {
                ...
                out[propertyName] = BasicUtils.mergeValue(out[propertyName], finalValue);
            }
