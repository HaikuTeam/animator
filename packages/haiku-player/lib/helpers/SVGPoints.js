...
function manaToPoints(mana) {
    if (SVG_TYPES[mana.elementName] &&
        ...
        var width_1 = parseCssValueString((mana.layout &&
            ...
            0).value;
        var height = parseCssValueString((mana.layout &&
            mana.layout.computed &&
            mana.layout.computed.size &&
            ...
            0).value;
        var left = parseCssValueString((mana.rect && mana.rect.left) ||
            (mana.attributes.style && mana.attributes.style.left) ||
            mana.attributes.x ||
            0).value;
        var top_1 = parseCssValueString((mana.rect && mana.rect.top) ||
