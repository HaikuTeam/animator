...
tape("nib:basic-command", (t) => {
  t.plan(1)

  let results = ""

  const mockContext = new Context(["thing1"], {}, {
    log: (output) => {
      console.log(output)
      results = output
    },
  ...
  t.equal(results, "success", "basic commands should execute")
})

tape("nib:basic-usage-banner", (t) => {
  t.plan(2)

  let results = ""

  const mockContext = new Context([], { help: "" }, {
    log: (output) => {
      console.log(output)
      results = output
    },
...
tape("nib:nested-command", (t) => {
  t.plan(1)

  let results = ""
  const mockContext = new Context(["nest", "egg"], {}, {
    log: (output) => {
      console.log(output)
      results = output
    },
  ...
  t.equal(results, "nest egg success", "nested commands should run")
})

tape("nib:nested-usage-banner", (t) => {
  t.plan(1)

  let results = ""
  const mockContext = new Context(["nest", "egg"], { help: "" }, {
    log: (output) => {
      console.log(output)
      results = output
    },
...
tape("nib:flag-defaults", (t) => {
  t.plan(4)

  let results = ""
  let mockContext = new Context(["check-default"], {}, {
    log: (output) => {
      console.log(output)
      results = output
    },
  ...
  mockContext = new Context(["check-default"], { a: "world" }, {
    log: (output) => {
      console.log(output)
      results = output
    },
  ...
  mockContext = new Context(["check-non-default"], {}, {
    log: (output) => {
      console.log(output)
      results = output
    },
  ...
  mockContext = new Context(["check-non-default"], { b: "world" }, {
    log: (output) => {
      console.log(output)
      results = output
    },
