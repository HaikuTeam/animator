...
export default function updateElement(
  ...
  if (Array.isArray(virtualElement.children)) {
    ...
    renderTree(domElement, virtualElement, virtualElement.children, instance, isPatchOperation, doSkipChildren);
    ...
    renderTree(domElement, virtualElement, [], instance, isPatchOperation, null);
  }
