...
module.exports = {
  metadata: {
    folder: "/Users/taylorpoe/.haiku/projects/taylor/canHasAnimate",
    uuid: "d2a3f783-27f7-47e2-9708-c52bc4e7625d",
    core: "3.4.0",
    player: "3.4.0",
    username: "taylor",
    organization: "taylor",
    project: "canHasAnimate",
    branch: "master",
    version: "0.0.0",
    title: "Main",
    type: "haiku",
  ...
  eventHandlers: {
    "haiku:e4a9e4d8baa7": {
      ...
      mouseenter: {
        handler: function(target, event) {
          this.getDefaultTimeline().gotoAndPlay(25);
        }
      },
      "timeline:Default:58": {
        handler: function(target, event) {
    ...
    Default: {
      ...
      "haiku:7016e0258cdd": {
        ...
        "translation.x": {
          ...
          "417": { value: 155.5, edited: true, curve: "linear" },
          "967": {
            value: Haiku.inject(
              function($user) {
                return $user.mouse.x;
        ...
        "translation.y": {
          ...
          "417": { value: 220, edited: true, curve: "linear" },
          "967": {
            value: Haiku.inject(
              function($user) {
                return $user.mouse.y;
      ...
      "haiku:8b2c1e3d7ee4": { "translation.x": { "0": { value: 116 } } },
      "haiku:8f23a4a1c414": {
        d: {
          "0": {
    ...
    children: [
      {
        ...
        attributes: {
          ...
          "haiku-id": "7016e0258cdd",
          "haiku-title": "haiku icon",
          "haiku-source": "designs/canHasAnimate.sketch.contents/slices/haiku icon.svg"
        },
        children: [
          {
            elementName: "g",
            attributes: { "haiku-id": "aae7b6113364", id: "Page-1" },
            children: [
              {
                elementName: "g",
                attributes: { "haiku-id": "6940d184793b", id: "Tutorial" },
                children: [
                  {
                    elementName: "g",
                    attributes: { "haiku-id": "8b2c1e3d7ee4", id: "equation" },
                    children: [
                      {
                        elementName: "path",
                        attributes: {
                          "haiku-id": "8f23a4a1c414",
                          id: "haiku-icon"
                        },
                        children: []
                      }
