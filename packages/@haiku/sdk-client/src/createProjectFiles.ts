...
export function createProjectFiles (
  ...
  try {
    ...
    const humanTimestamp = getCurrentHumanTimestamp();
    ...
    return fetchProjectConfigInfo(projectPath, (err: any, userconfig: any) => {
      ...
      return async.parallel([
        (cb) => {
          ...
          return createBundle(
            path.join(projectPath, 'code/main'),
            path.join(projectPath, 'code/main/dom-embed.js'),
            embedName,
            (bundleErr: any, bundledContents: any) => {
              ...
              fse.outputFileSync(path.join(projectPath, 'index.embed.js'), finalContent);
              return cb();
            },
            );
        },
        (cb) => {
          ...
          return createBundle(
            path.join(projectPath, 'code/main'),
            path.join(projectPath, 'code/main/dom-standalone.js'),
            standaloneName,
            (bundleErr: any, bundledContents: any) => {
              if (bundleErr) {
                return cb(bundleErr);
              ...
              const finalContent = `/** ${autoGeneratedNotice}\n${copyrightNotice}\n*/\n${bundledContents}`;
              fse.outputFileSync(path.join(projectPath, 'index.standalone.js'), finalContent);
              return cb();
            },
            );
        },
