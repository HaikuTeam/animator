  ...
  try {
    ...
    if (organizationName && organizationName !== FALLBACK_ORG_NAME) {
      ...
      if (upgradeDiff === 'patch') {
        _LoggerInstance2.default.sacred('[project folder] upgraded @haiku/player to', haikuPlayerVersion);
        packageJson.dependencies['@haiku/player'] = haikuPlayerVersion;
      }
    }
    ...
    return npmActions(projectPath, projectDependencies, function (err) {
      ...
      _haikuFsExtra2.default.outputFileSync(dir(projectPath, 'LICENSE.txt'), (0, _dedent2.default)(_templateObject6, copyrightNotice));
      ...
      _haikuFsExtra2.default.outputFileSync(dir(projectPath, 'index.js'), (0, _dedent2.default)(_templateObject7));
      _haikuFsExtra2.default.outputFileSync(dir(projectPath, 'react.js'), (0, _dedent2.default)(_templateObject8));
      _haikuFsExtra2.default.outputFileSync(dir(projectPath, 'react-bare.js'), (0, _dedent2.default)(_templateObject9, reactProjectName, reactProjectName, reactProjectName, reactProjectName, reactProjectName));

      _haikuFsExtra2.default.outputFileSync(dir(projectPath, 'code/main/dom.js'), (0, _dedent2.default)(_templateObject10));
      _haikuFsExtra2.default.outputFileSync(dir(projectPath, 'code/main/dom-embed.js'), (0, _dedent2.default)(_templateObject11, haikuPlayerVersion, haikuPlayerVersion, haikuPlayerVersion, embedName));
      _haikuFsExtra2.default.outputFileSync(dir(projectPath, 'code/main/dom-standalone.js'), (0, _dedent2.default)(_templateObject12));
      _haikuFsExtra2.default.outputFileSync(dir(projectPath, 'code/main/react-dom.js'), (0, _dedent2.default)(_templateObject13, reactProjectName, reactProjectName, reactProjectName, reactProjectName, reactProjectName));

      _haikuFsExtra2.default.outputFileSync(dir(projectPath, 'preview.html'), (0, _dedent2.default)(_templateObject14, projectNameSafe, standaloneName));

      // Should we try to merge these if the user made any changes?
      _haikuFsExtra2.default.outputFileSync(dir(projectPath, '.gitignore'), (0, _dedent2.default)(_templateObject15));
      _haikuFsExtra2.default.outputFileSync(dir(projectPath, '.npmignore'), (0, _dedent2.default)(_templateObject16));
      _haikuFsExtra2.default.outputFileSync(dir(projectPath, '.yarnignore'), (0, _dedent2.default)(_templateObject16));
      _haikuFsExtra2.default.outputFileSync(dir(projectPath, '.npmrc'), (0, _dedent2.default)(_templateObject17));
      _haikuFsExtra2.default.outputFileSync(dir(projectPath, '.yarnrc'), (0, _dedent2.default)(_templateObject18));
