...
export const createCDNBundles = (
  ...
  const embedName = getEmbedName(organizationName, project.projectPath, project.projectName);
  const standaloneName = getStandaloneName(organizationName, project.projectPath, project.projectName);
