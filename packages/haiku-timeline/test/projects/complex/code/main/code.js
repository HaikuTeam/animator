module.exports = {
  ...
  timelines: {
    Default: {
      'haiku:f203a65f49c0': {
        ...
        'translation.x': { '0': { value: 50, curve: 'linear' }, '1000': { value: 55, curve: 'linear' }, '2000': {value: 56, curve: 'linear'}, '3000': {value: 100} },
        'translation.y': { '0': { value: 55 }, '3000': { value: 300 } },
        'style.outline': { '0': { value: '1px solid gray' } },
        'scale.x': { '0': { value: 0 }, '10': { value: 0 }, '20': { value: 0 }, '166': { value: 0 }, '200': { value: 0 }, '300': { value: 0 }, '400': { value: 0 }, '500': { value: 0 }, '600': { value: 0 }, '700': { value: 0 }, '800': { value: 0 } },
        'backgroundColor': {
          '0': { value: function () {
      ...
      'haiku:e5e416e36283': {
        ...
        'scale.y': {
          '0': { value: 1.4844644736875778, edited: true, curve: 'easeInOutBounce' },
          '100': { value: 2 },
  ...
  template: {
    ...
    elementName: 'div',
    attributes: { 'haiku-title': 'ComplexYayayHeyHeyWawaGoogoo', 'haiku-id': 'f203a65f49c0' }
  }
}
