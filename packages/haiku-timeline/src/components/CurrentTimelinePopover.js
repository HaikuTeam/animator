...
import DuplicateIconSVG from './icons/DuplicateIconSVG'
import EditsIconSVG from './icons/EditsIconSVG'
import DeleteIconSVG from './icons/DeleteIconSVG'
import CheckmarkIconSVG from './icons/CheckmarkIconSVG'
import ChevronLeftIconSVG from './icons/ChevronLeftIconSVG'
...
class CurrentTimelinePopover extends React.Component {
  ...
  handleCreateTimeline (event, form) {
    event.preventDefault()
    let name = this.creationInput.value
        ...
        {this.props.timelineNames.map((timelineName) => {
          return (
            <div
              ...
              <form
                onSubmit={(e) => { this.handleRename(e, timelineName) }}
                onFocus={(e) => { this.setState({focusedTimeline: timelineName}) }}
                ...
                <div>
                  <input
                    ...
                    ref={(input) => { this[timelineName] = input }} />
