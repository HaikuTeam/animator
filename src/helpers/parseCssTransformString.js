...
function parseCssTransformString (str) {
  ...
  var matrices = specs.map(function _map (spec) {
    ...
    switch (spec.type) {
      // 1D
      case 'rotatex': layout.rotate[0] = spec.values[0].value; break
      case 'rotatey': layout.rotate[1] = spec.values[0].value; break
      case 'rotatez': layout.rotate[2] = spec.values[0].value; break
      case 'translatex': layout.translate[0] = spec.values[0].value; break
      case 'translatey': layout.translate[1] = spec.values[0].value; break
      case 'translatez': layout.translate[2] = spec.values[0].value; break
      case 'scalex': layout.scale[0] = spec.values[0].value; break
      case 'scaley': layout.scale[1] = spec.values[0].value; break
      case 'scalez': layout.scale[2] = spec.values[0].value; break
      ...
      case 'matrix3d': return Layout3D.copyMatrix([], spec.values.map((val) => val.value))
  ...
  components.rotation = _getEulerAngles(components.quaternion[0], components.quaternion[1], components.quaternion[2], components.quaternion[3])
  ...
  if (components.translation[1] !== 0) out['translation.y'] = components.translation[1]
  if (components.translation[2] !== 0) out['translation.z'] = components.translation[2]
