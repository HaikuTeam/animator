...
export default class ValueBuilder {
  ...
  constructor (component: HaikuComponent) {
    ...
    // TODO:  get Helpers dynamically, as defined on the component, merged with the static list of helpers
    const helpers =  Object.assign({}, HaikuHelpers.helpers, component.getHelpers());
    ...
    this.helpers.find = (selector: string) => {
      return this._component.querySelectorAll(selector);
    };

    console.log('FINAL HELPERS', this.helpers);
  }
