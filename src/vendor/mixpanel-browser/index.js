...
_.cookie = {
  ...
  set_seconds: function (name, value, seconds, cross_subdomain, is_secure) {
    ...
    if (cross_subdomain) {
      var matches = document$1.location.hostname.match(
