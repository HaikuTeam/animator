...
const POLYLINE_FALLBACKS = {
  points: '',
};
const POLYGON_FALLBACKS = {
  points: '',
};
...
export default {
  ...
  circle: has(CONTROL_FLOW_FALLBACKS, LAYOUT_2D_FALLBACKS, PRESENTATION_FALLBACKS, CIRCLE_FALLBACKS),
  cite: has(
    HTML_STYLE_SHORTHAND_FALLBACKS,
    TEXT_CONTENT_FALLBACKS,
    CONTROL_FLOW_FALLBACKS,
  ...
  ellipse: has(CONTROL_FLOW_FALLBACKS, LAYOUT_3D_FALLBACKS, PRESENTATION_FALLBACKS, ELLIPSE_FALLBACKS),
  em: has(
    HTML_STYLE_SHORTHAND_FALLBACKS,
    TEXT_CONTENT_FALLBACKS,
    CONTROL_FLOW_FALLBACKS,
  ...
  line: has(CONTROL_FLOW_FALLBACKS, LAYOUT_2D_FALLBACKS, PRESENTATION_FALLBACKS, LINE_FALLBACKS),
  linearGradient: has(
    CONTROL_FLOW_FALLBACKS,
    LAYOUT_3D_FALLBACKS,
    PRESENTATION_FALLBACKS,
  ...
  path: has(CONTROL_FLOW_FALLBACKS, LAYOUT_2D_FALLBACKS, PRESENTATION_FALLBACKS, PATH_FALLBACKS),
  pattern: has(CONTROL_FLOW_FALLBACKS, LAYOUT_3D_FALLBACKS, PRESENTATION_FALLBACKS),
  polygon: has(CONTROL_FLOW_FALLBACKS, LAYOUT_2D_FALLBACKS, PRESENTATION_FALLBACKS, POLYGON_FALLBACKS),
  polyline: has(CONTROL_FLOW_FALLBACKS, LAYOUT_2D_FALLBACKS, PRESENTATION_FALLBACKS, POLYLINE_FALLBACKS),
  pre: has(
    HTML_STYLE_SHORTHAND_FALLBACKS,
    TEXT_CONTENT_FALLBACKS,
    CONTROL_FLOW_FALLBACKS,
  ...
  rect: has(CONTROL_FLOW_FALLBACKS, LAYOUT_2D_FALLBACKS, PRESENTATION_FALLBACKS, RECT_FALLBACKS),
